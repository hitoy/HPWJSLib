 ...
 */
(function(w){'use strict';var version='0.0.7';var readyState=w.document.readyState;var carousels;if(readyState==="complete"){init();}else{w.addEventListener("load",init);}
