 ...
 */
(function(w){'use strict';var version='1.2.2';var readyState=w.document.readyState;var carousels;if(readyState==="complete"){carouselparse();}else{w.addEventListener("load",carouselparse);}
...
function disabled(){return in_transition&&enable;}
...
enable_page_button(nextbutton);carouselscroll.setAttribute('data-translate',0);var positionoffset=0;if(loop&currentindex===0){var origin_sliders=carouselscroll.children;for(var i=0;i<=slidercountinview;i++){var clone=origin_sliders[i].cloneNode(true);carouselscroll.appendChild(clone);}
