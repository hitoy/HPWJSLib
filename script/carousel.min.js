...
function attachObserver(){var carouselwrapobserver=new IntersectionObserver(function(entries){entries.forEach(function(entry){if(entry.target==carouselwrap){carouselthreshold=entry.intersectionRatio;}});},{rootMargin:'0px',threshold:[0,0.25,0.5,0.75,1]});carouselwrapobserver.observe(carouselwrap);}
...
var carousel=new Carousel(carouselscroll,duration,delay,loop,step,direction,mousewheel,indicator,nextbutton,previousbutton,carouselscrollactiveclass,activeclass);if(autoplay)carousel.play();});}
