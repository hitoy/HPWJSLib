 ...
 */
(function(w){'use strict';var version='1.2.1';var readyState=w.document.readyState;var carousels;if(readyState==="complete"){carouselparse();}else{w.addEventListener("load",carouselparse);}
