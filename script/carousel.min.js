 ...
 */
(function(w){'use strict';var version='0.0.5';var readyState=w.document.readyState;var carousels;if(readyState==="interactive"||readyState==="complete"){init();}else{w.document.addEventListener("DOMContentLoaded",init);}
